...
export default function DrawerMainPage (props) {
  ...
  const leftMenu = [{name:'Daily analysis',path: "/home-preview"}, {name:'Detecion Repo',path: "/analyticsDetecionPage"},{name:'Clips Repos',path:'/videoClipsPage',},{name:'Data Prep Tool',path:'/Dashboard/paymentMethods'}]
